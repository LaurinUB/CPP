...
/*   Updated: 2023/05/20 13:43:21 by luntiet-         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void  Harl::info(void) {
  ...
  std::cout <<"If you did, I wouldn’t be asking for more!" WHITE << std::endl
  << std::endl;
}
...
void  Harl::error(void) {
  ...
  std::cout << "This is unacceptable! I want to speak to the manager now." WHITE
  << std::endl << std::endl;
}
...
void  Harl::complain(std::string level) {
  ...
  std::cout << RED "This [ " << level << " ] is not a complain!" WHITE
  << std::endl;
}
